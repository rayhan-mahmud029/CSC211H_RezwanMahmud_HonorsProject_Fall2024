...
struct qt_meta_stringdata_CLASSRequestENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSRequestENDCLASS = QtMocHelpers::stringData(
    "Request",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSRequestENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Request::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSRequestENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSRequestENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRequestENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Request::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSRequestENDCLASS.stringdata0))
